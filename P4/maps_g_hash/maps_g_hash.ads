...
private
  ...
  type Linked_List is access Linked_List_Cell; -- puntero al principio
  type Linked_List_Cell is record
    Key: Key_Type;
    Value: Value_Type;
    Next: Linked_List;
  end record;
  --type Linked_List is record
    --P_First: Linked_List_Cell_A;
    --P_Last: Linked_List; -- Nota: Comentar
--end record;

   -- Hash Map
   type Map_Array is array (Hash_Range) of Linked_List;
   ...
   type Cursor is record
      ...
      Element_A: Linked_List;   -- Indice de la lista enlazada donde me hallo
   end record;
